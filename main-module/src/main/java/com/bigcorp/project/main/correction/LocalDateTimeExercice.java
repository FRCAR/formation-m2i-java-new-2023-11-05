...
public class LocalDateTimeExercice {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Le dernier mardi précédant aujourd'hui est : " + 
					LocalDate.now().with(TemporalAdjusters.previous(DayOfWeek.TUESDAY)));
			

			System.out.println("Le premier jour de la semaine dans 4 années est : " + 
					LocalDate.now().plusYears(3).with(TemporalAdjusters.firstDayOfNextYear()).getDayOfWeek());
